...
public class TabFragment1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        System.out.println("POSTLOADER LOADED");
        postsLoader = new PostsLoader(getActivity(), view, mParam1, mParam2);
        return view;
    }


    public void update(){
        postsLoader.refreshAll();
    }

    // TODO: Rename method, organizePosts argument and hook method into UI event
    ...
    public void onAttach(Context context) {
        ...
        System.out.println("ATTACHED: " + mParam1);
    ...
    public void onDetach() {
        super.onDetach();
        mListener = null;
        System.out.println("DETACHED: " + mParam1);
    }
